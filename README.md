...
Install with `npm i -S kuara-signpdf kuara-forge`.
...
[kuara-forge](https://github.com/digitalbazaar/forge) is used for working with signatures.
...
- [kuara-forge](https://github.com/digitalbazaar/forge) is an awesome package written in pure JavaScript and [supports signing in detached mode](https://github.com/digitalbazaar/forge/pull/605). Many thanks to all the guys who wrote and maintain it.
